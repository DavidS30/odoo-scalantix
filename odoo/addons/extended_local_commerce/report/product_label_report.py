...
class ReportProductTemplateLabelDymo3x1(models.AbstractModel):
    _name = 'report.extended_local_commerce.label_dymo_3x1'
    _description = 'Product Label Report Dymo 3x1'
